...
execute as @s[x=3449,y=0,z=482,dx=31,dy=44,dz=19] unless entity @s[scores={Location=10}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
#execute as @s[] unless entity @s[scores={Location=28}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2803,y=0,z=-4122,dx=109,dy=256,dz=73] unless entity @s[scores={Location=69}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4097,y=12,z=-4376,dx=77,dy=20,dz=95] unless entity @s[scores={Location=89}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4217,y=30,z=-3955,dx=32,dy=150,dz=47] unless entity @s[scores={Location=96}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4147,y=0,z=437,dx=144,dy=256,dz=163] unless entity @s[scores={Location=104}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3062,y=26,z=327,dx=10,dy=6,dz=320] unless entity @s[scores={Location=99}] run title @s actionbar {"text":"Underground Path"}
execute as @s[x=3062,y=26,z=327,dx=10,dy=6,dz=320] unless entity @s[scores={Location=99}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=3062,y=26,z=327,dx=10,dy=6,dz=320] unless entity @s[scores={Location=99}] run scoreboard players set @s Location 99
execute as @s[x=3062,y=26,z=327,dx=10,dy=6,dz=320] run tag @s add Indoors


#Underground Path (Kanto Routes 7-8)
execute as @s[x=2910,y=18,z=464,dx=414,dy=6,dz=70] unless entity @s[scores={Location=100}] run title @s actionbar {"text":"Underground Path"}
execute as @s[x=2910,y=18,z=464,dx=414,dy=6,dz=70] unless entity @s[scores={Location=100}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=2910,y=18,z=464,dx=414,dy=6,dz=70] unless entity @s[scores={Location=100}] run scoreboard players set @s Location 100
execute as @s[x=2910,y=18,z=464,dx=414,dy=6,dz=70] run tag @s add Indoors


#Pokémon Network Center
execute as @s[x=4274,y=25,z=-2363,dx=45,dy=13,dz=27] unless entity @s[scores={Location=73}] run title @s actionbar {"text":"Pokémon Network Center"}
execute as @s[x=4274,y=25,z=-2363,dx=45,dy=13,dz=27] unless entity @s[scores={Location=73}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4130,y=33,z=-167,dx=26,dy=9,dz=16,tag=!InDialogue] unless entity @s[scores={Location=75}] run title @s actionbar {"text":"Professor Oak's Laboratory"}
execute as @s[x=4130,y=33,z=-167,dx=26,dy=9,dz=16,tag=!InDialogue] unless entity @s[scores={Location=75}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=4130,y=33,z=-167,dx=26,dy=9,dz=16,tag=!InDialogue] unless entity @s[scores={Location=75}] run scoreboard players set @s Location 75
execute as @s[x=4130,y=33,z=-167,dx=26,dy=9,dz=16,tag=!InDialogue] run tag @s add Indoors
...
execute at @e[type=armor_stand,name=PokemonCenter] as @a[distance=..10] unless entity @s[scores={Location=200}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3129,y=0,z=1912,dx=175,dy=100,dz=129] unless entity @s[scores={Location=1}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3244,y=0,z=-1551,dx=196,dy=256,dz=264] unless entity @s[scores={Location=2}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3610,y=0,z=-3726,dx=226,dy=256,dz=210] unless entity @s[scores={Location=3}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2896,y=0,z=-1551,dx=347,dy=256,dz=118] unless entity @s[scores={Location=4}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4178,y=0,z=-4377,dx=130,dy=256,dz=177] unless entity @s[scores={Location=5}] unless entity @s[scores={Location=90}] unless entity @s[scores={Location=84}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3224,y=0,z=-2169,dx=216,dy=256,dz=187] unless entity @s[scores={Location=6}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3335,y=0,z=396,dx=302,dy=256,dz=203,tag=!Indoors] unless entity @s[scores={Location=7}] unless entity @s[scores={Location=8}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
#execute as @s[] unless entity @s[scores={Location=9}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2779,y=0,z=1845,dx=236,dy=256,dz=149] unless entity @s[scores={Location=11}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3006,y=0,z=804,dx=229,dy=256,dz=169,tag=!Indoors] unless entity @s[scores={Location=12}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4098,y=0,z=-793,dx=146,dy=256,dz=139,tag=!Indoors] unless entity @s[scores={Location=13}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
#execute as @s[] unless entity @s[scores={Location=14}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2750,y=0,z=1394,dx=320,dy=256,dz=290] unless entity @s[scores={Location=15}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4091,y=33,z=1720,dx=54,dy=101,dz=44] unless entity @s[scores={Location=16}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4578,y=-11,z=850,dx=61,dy=43,dz=463] unless entity @s[scores={Location=17}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3910,y=0,z=1392,dx=138,dy=70,dz=197] unless entity @s[scores={Location=18}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27] unless entity @s[scores={Location=19}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3116,y=0,z=-3067,dx=128,dy=256,dz=108,tag=!Indoors] unless entity @s[scores={Location=20}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3012,y=0,z=-3159,dx=103,dy=256,dz=218] unless entity @s[scores={Location=21}] unless entity @s[scores={Location=60}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3116,y=0,z=-3159,dx=32,dy=256,dz=91] unless entity @s[scores={Location=21}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4155,y=0,z=-3426,dx=243,dy=256,dz=272,tag=!Indoors] unless entity @s[scores={Location=22}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3333,y=0,z=-489,dx=274,dy=256,dz=194,tag=!Indoors] unless entity @s[scores={Location=23}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2773,y=0,z=-4178,dx=369,dy=256,dz=129,tag=!Indoors] unless entity @s[scores={Location=106}] unless entity @s[scores={Location=79}] unless entity @s[scores={Location=67}] unless entity @s[scores={Location=24}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4315,y=0,z=1331,dx=397,dy=100,dz=243] unless entity @s[scores={Location=25}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3399,y=33,z=1874,dx=141,dy=107,dz=152] unless entity @s[scores={Location=26}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4379,y=0,z=899,dx=150,dy=256,dz=246] unless entity @s[scores={Location=27}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4590,y=30,z=1785,dx=226,dy=50,dz=190] unless entity @s[scores={Location=29}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
#Kanto Route 1
execute as @s[x=4100,y=0,z=-98,dx=127,dy=256,dz=199,tag=!InDialogue] unless entity @s[scores={Location=30}] run title @s actionbar {"text":"Route 1"}
execute as @s[x=4100,y=0,z=-98,dx=127,dy=256,dz=199,tag=!InDialogue] unless entity @s[scores={Location=30}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=4100,y=0,z=-98,dx=127,dy=256,dz=199,tag=!InDialogue] unless entity @s[scores={Location=30}] run scoreboard players set @s Location 30
...
execute as @s[x=4086,y=0,z=290,dx=218,dy=256,dz=413,tag=!Indoors] unless entity @s[scores={Location=31}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3620,y=0,z=703,dx=425,dy=256,dz=244,tag=!Indoors] unless entity @s[scores={Location=32}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3236,y=0,z=804,dx=383,dy=256,dz=143] unless entity @s[scores={Location=33}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
#Kanto Route 5
execute as @s[x=3028,y=0,z=605,dx=147,dy=256,dz=198,tag=!Indoors] unless entity @s[scores={Location=34}] run title @s actionbar {"text":"Route 5"}
execute as @s[x=3028,y=0,z=605,dx=147,dy=256,dz=198,tag=!Indoors] unless entity @s[scores={Location=34}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=3028,y=0,z=605,dx=147,dy=256,dz=198,tag=!Indoors] unless entity @s[scores={Location=34}] run scoreboard players set @s Location 34



#Kanto Route 6
execute as @s[x=3042,y=0,z=215,dx=132,dy=256,dz=171,tag=!Indoors] unless entity @s[scores={Location=35}] run title @s actionbar {"text":"Route 6"}
execute as @s[x=3042,y=0,z=215,dx=132,dy=256,dz=171,tag=!Indoors] unless entity @s[scores={Location=35}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=3042,y=0,z=215,dx=132,dy=256,dz=171,tag=!Indoors] unless entity @s[scores={Location=35}] run scoreboard players set @s Location 35



#Kanto Route 7
execute as @s[x=3237,y=0,z=432,dx=97,dy=256,dz=122,tag=!Indoors] unless entity @s[scores={Location=36}] run title @s actionbar {"text":"Route 7"}
execute as @s[x=3237,y=0,z=432,dx=97,dy=256,dz=122,tag=!Indoors] unless entity @s[scores={Location=36}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=3237,y=0,z=432,dx=97,dy=256,dz=122,tag=!Indoors] unless entity @s[scores={Location=36}] run scoreboard players set @s Location 36



#Kanto Route 8
execute as @s[x=2643,y=0,z=426,dx=328,dy=256,dz=117,tag=!Indoors] unless entity @s[scores={Location=37}] run title @s actionbar {"text":"Route 8"}
execute as @s[x=2643,y=0,z=426,dx=328,dy=256,dz=117,tag=!Indoors] unless entity @s[scores={Location=37}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=2643,y=0,z=426,dx=328,dy=256,dz=117,tag=!Indoors] unless entity @s[scores={Location=37}] run scoreboard players set @s Location 37



#Kanto Route 9
execute as @s[x=2638,y=0,z=841,dx=367,dy=256,dz=97] unless entity @s[scores={Location=38}] run title @s actionbar {"text":"Route 9"}
execute as @s[x=2638,y=0,z=841,dx=367,dy=256,dz=97] unless entity @s[scores={Location=38..39}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2483,y=0,z=556,dx=154,dy=256,dz=382,tag=!Indoors] unless entity @s[scores={Location=38..39}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2680,y=0,z=30,dx=295,dy=256,dz=129] unless entity @s[scores={Location=40..44}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2483,y=0,z=-154,dx=196,dy=256,dz=579] unless entity @s[scores={Location=40..44}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2483,y=0,z=-233,dx=494,dy=256,dz=78] unless entity @s[scores={Location=40..44}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2859,y=0,z=-446,dx=118,dy=256,dz=212] unless entity @s[scores={Location=40..44}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2978,y=0,z=-446,dx=354,dy=256,dz=96] unless entity @s[scores={Location=40..44}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3638,y=0,z=443,dx=235,dy=256,dz=91] unless entity @s[scores={Location=45..47}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3702,y=0,z=-337,dx=171,dy=256,dz=779] unless entity @s[scores={Location=45..47}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3608,y=0,z=-489,dx=262,dy=256,dz=151] unless entity @s[scores={Location=45..47}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3373,y=0,z=-839,dx=164,dy=256,dz=349] unless entity @s[scores={Location=48..49}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3538,y=0,z=-839,dx=559,dy=256,dz=349] unless entity @s[scores={Location=48..49}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4098,y=0,z=-653,dx=129,dy=256,dz=454] unless entity @s[scores={Location=50}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4265,y=0,z=139,dx=242,dy=256,dz=111] unless entity @s[scores={Location=51}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4379,y=0,z=251,dx=150,dy=256,dz=647] unless entity @s[scores={Location=52}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3053,y=0,z=974,dx=117,dy=256,dz=124] unless entity @s[scores={Location=53..54}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2725,y=0,z=1099,dx=445,dy=256,dz=91] unless entity @s[scores={Location=53..54}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3191,y=0,z=-294,dx=510,dy=256,dz=245] unless entity @s[scores={Location=55}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4083,y=0,z=-2471,dx=159,dy=256,dz=757] unless entity @s[scores={Location=56}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2483,y=0,z=426,dx=159,dy=256,dz=129,tag=!Indoors] unless entity @s[scores={Location=57}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3926,y=40,z=1182,dx=30,dy=20,dz=30] unless entity @s[scores={Location=58}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
#Lost Cave
execute as @s[x=4065,y=32,z=1579,dx=260,dy=30,dz=111] unless entity @s[scores={Location=59}] run title @s actionbar {"text":"Lost Cave"}
execute as @s[x=4065,y=32,z=1579,dx=260,dy=30,dz=111] unless entity @s[scores={Location=59}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2881,y=0,z=-3357,dx=130,dy=256,dz=325] unless entity @s[scores={Location=60}] unless entity @s[scores={Location=21}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3012,y=0,z=-3357,dx=54,dy=256,dz=187] unless entity @s[scores={Location=60}] unless entity @s[scores={Location=21}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3996,y=0,z=-1713,dx=336,dy=256,dz=421] unless entity @s[scores={Location=61..62}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3600,y=0,z=1811,dx=717,dy=256,dz=289] unless entity @s[scores={Location=61..62}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2384,y=0,z=1398,dx=259,dy=256,dz=648] unless entity @s[scores={Location=63}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
#Navel Rock (Exterior)
execute as @s[x=2650,y=1,z=-2560,dx=229,dy=256,dz=503] unless entity @s[scores={Location=64}] run title @s actionbar {"text":"Navel Rock"}
execute as @s[x=2650,y=1,z=-2560,dx=229,dy=256,dz=503] unless entity @s[scores={Location=64}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=2650,y=1,z=-2560,dx=229,dy=256,dz=503] unless entity @s[scores={Location=64}] run scoreboard players set @s Location 64



#Navel Rock (Interior)
execute as @s[x=2650,y=-64,z=-2560,dx=64,dy=256,dz=503] unless entity @s[scores={Location=65}] run title @s actionbar {"text":"Navel Rock"}
execute as @s[x=2650,y=-64,z=-2560,dx=64,dy=256,dz=503] unless entity @s[scores={Location=65}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=2650,y=-64,z=-2560,dx=64,dy=256,dz=503] unless entity @s[scores={Location=65}] run scoreboard players set @s Location 65



#One Island (town)
execute as @s[x=4243,y=0,z=-2471,dx=129,dy=256,dz=183,tag=!Indoors] unless entity @s[scores={Location=66}] run title @s actionbar {"text":"One Island"}
execute as @s[x=4243,y=0,z=-2471,dx=129,dy=256,dz=183,tag=!Indoors] unless entity @s[scores={Location=66}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=4243,y=0,z=-2471,dx=129,dy=256,dz=183,tag=!Indoors] unless entity @s[scores={Location=66}] run scoreboard players set @s Location 66
...
execute as @s[x=2996,y=0,z=-4048,dx=169,dy=256,dz=383] unless entity @s[scores={Location=106}] unless entity @s[scores={Location=79}] unless entity @s[scores={Location=67}] unless entity @s[scores={Location=24}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
#Pallet Town
execute as @s[x=4101,y=0,z=-198,dx=126,dy=256,dz=99,tag=!Indoors,tag=!InDialogue] unless entity @s[scores={Location=68}] run title @s actionbar {"text":"Pallet Town"}
execute as @s[x=4101,y=0,z=-198,dx=126,dy=256,dz=99,tag=!Indoors,tag=!InDialogue] unless entity @s[scores={Location=68}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=4101,y=0,z=-198,dx=126,dy=256,dz=99,tag=!Indoors,tag=!InDialogue] unless entity @s[scores={Location=68}] run scoreboard players set @s Location 68
...
execute as @s[x=4046,y=0,z=703,dx=227,dy=256,dz=201,tag=!Indoors] unless entity @s[scores={Location=71}] unless entity @s[scores={Location=70}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3805,y=33,z=1636,dx=253,dy=256,dz=155] unless entity @s[scores={Location=72}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4375,y=0,z=1608,dx=126,dy=200,dz=105] unless entity @s[scores={Location=74}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2838,y=0,z=-2855,dx=409,dy=256,dz=116] unless entity @s[scores={Location=76}] unless entity @s[scores={Location=105}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2838,y=0,z=-2898,dx=277,dy=256,dz=42] unless entity @s[scores={Location=76}] unless entity @s[scores={Location=105}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3176,y=0,z=1392,dx=239,dy=256,dz=415] unless entity @s[scores={Location=77}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3056,y=-15,z=-3063,dx=90,dy=15,dz=80] unless entity @s[scores={Location=78}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2773,y=0,z=-4696,dx=261,dy=256,dz=250] unless entity @s[scores={Location=106}] unless entity @s[scores={Location=79}] unless entity @s[scores={Location=67}] unless entity @s[scores={Location=24}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3030,y=0,z=-48,dx=206,dy=256,dz=50] unless entity @s[scores={Location=80}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
#Saffron City
execute as @s[x=2972,y=0,z=387,dx=264,dy=256,dz=217,tag=!Indoors] unless entity @s[scores={Location=81}] run title @s actionbar {"text":"Saffron City"}
execute as @s[x=2972,y=0,z=387,dx=264,dy=256,dz=217,tag=!Indoors] unless entity @s[scores={Location=81}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
execute as @s[x=2972,y=0,z=387,dx=264,dy=256,dz=217,tag=!Indoors] unless entity @s[scores={Location=81}] run scoreboard players set @s Location 81
...
execute as @s[x=3506,y=0,z=1641,dx=206,dy=256,dz=133] unless entity @s[scores={Location=83}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4041,y=0,z=-4606,dx=136,dy=256,dz=406,tag=!Indoors] unless entity @s[scores={Location=84}] unless entity @s[scores={Location=90}] unless entity @s[scores={Location=5}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4131,y=0,z=-4199,dx=203,dy=256,dz=112,tag=!Indoors] unless entity @s[scores={Location=85}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4354,y=0,z=1751,dx=176,dy=200,dz=141] unless entity @s[scores={Location=86}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4354,y=0,z=1894,dx=176,dy=200,dz=141] unless entity @s[scores={Location=86}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2773,y=0,z=-4445,dx=169,dy=256,dz=186,tag=!Indoors] unless entity @s[scores={Location=87}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3694,y=-10,z=-4718,dx=770,dy=12,dz=72] unless entity @s[scores={Location=88}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3735,y=0,z=-4767,dx=688,dy=256,dz=160] unless entity @s[scores={Location=90}] unless entity @s[scores={Location=84}] unless entity @s[scores={Location=5}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4542,y=0,z=1587,dx=154,dy=256,dz=145] unless entity @s[scores={Location=91}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2714,y=10,z=-1614,dx=181,dy=256,dz=181,tag=!Indoors] unless entity @s[scores={Location=92}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2695,y=-6,z=-1638,dx=145,dy=17,dz=44] unless entity @s[scores={Location=93}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2673,y=10,z=-1728,dx=222,dy=256,dz=113] unless entity @s[scores={Location=94}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4131,y=0,z=-4086,dx=203,dy=256,dz=210,tag=!Indoors] unless entity @s[scores={Location=95}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4225,y=0,z=-2698,dx=147,dy=256,dz=226] unless entity @s[scores={Location=97}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3224,y=0,z=-2292,dx=327,dy=256,dz=122,tag=!Indoors] unless entity @s[scores={Location=98}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2976,y=0,z=3,dx=259,dy=256,dz=211,tag=!Indoors] unless entity @s[scores={Location=101}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3506,y=0,z=1393,dx=325,dy=256,dz=180] unless entity @s[scores={Location=102}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=4057,y=0,z=102,dx=207,dy=256,dz=187,tag=!Indoors] unless entity @s[scores={Location=103}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=3116,y=0,z=-2960,dx=337,dy=256,dz=104] unless entity @s[scores={Location=105}] unless entity @s[scores={Location=76}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound
...
execute as @s[x=2627,y=0,z=-4610,dx=145,dy=256,dz=562] unless entity @s[scores={Location=106}] unless entity @s[scores={Location=79}] unless entity @s[scores={Location=67}] unless entity @s[scores={Location=24}] unless entity @s[tag=Cycling] run function kanto:triggers/stopsound

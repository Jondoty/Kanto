...
execute as @s[x=3062,y=26,z=327,dx=10,dy=6,dz=320] unless entity @s[scores={Location=99}] run function kanto:triggers/stopsound
...
execute as @s[x=2910,y=18,z=464,dx=414,dy=6,dz=70] unless entity @s[scores={Location=100}] run function kanto:triggers/stopsound
...
execute as @s[x=4274,y=25,z=-2363,dx=45,dy=13,dz=27] unless entity @s[scores={Location=73}] run function kanto:triggers/stopsound
...
execute as @s[x=4130,y=33,z=-167,dx=26,dy=9,dz=16,tag=!InDialogue] unless entity @s[scores={Location=75}] run function kanto:triggers/stopsound
...
execute as @s[x=4100,y=0,z=-98,dx=127,dy=256,dz=199,tag=!InDialogue] unless entity @s[scores={Location=30}] run function kanto:triggers/stopsound
...
execute as @s[x=3028,y=0,z=605,dx=147,dy=256,dz=198,tag=!Indoors] unless entity @s[scores={Location=34}] run function kanto:triggers/stopsound
...
execute as @s[x=3042,y=0,z=215,dx=132,dy=256,dz=171,tag=!Indoors] unless entity @s[scores={Location=35}] run function kanto:triggers/stopsound
...
execute as @s[x=3237,y=0,z=432,dx=97,dy=256,dz=122,tag=!Indoors] unless entity @s[scores={Location=36}] run function kanto:triggers/stopsound
...
execute as @s[x=2643,y=0,z=426,dx=328,dy=256,dz=117,tag=!Indoors] unless entity @s[scores={Location=37}] run function kanto:triggers/stopsound
...
#Navel Rock (Exterior)
execute as @s[x=2650,y=1,z=-2560,dx=229,dy=256,dz=503] unless entity @s[scores={Location=64}] run title @s actionbar {"text":""}
execute as @s[x=2650,y=1,z=-2560,dx=229,dy=256,dz=503] unless entity @s[scores={Location=64}] run function kanto:triggers/stopsound
...
#Navel Rock (Interior)
execute as @s[x=2650,y=-64,z=-2560,dx=64,dy=256,dz=503] unless entity @s[scores={Location=65}] run title @s actionbar {"text":""}
execute as @s[x=2650,y=-64,z=-2560,dx=64,dy=256,dz=503] unless entity @s[scores={Location=65}] run function kanto:triggers/stopsound
...
execute as @s[x=4243,y=0,z=-2471,dx=129,dy=256,dz=183,tag=!Indoors] unless entity @s[scores={Location=66}] run function kanto:triggers/stopsound
...
execute as @s[x=4101,y=0,z=-198,dx=126,dy=256,dz=99,tag=!Indoors,tag=!InDialogue] unless entity @s[scores={Location=68}] run function kanto:triggers/stopsound
...
execute as @s[x=2972,y=0,z=387,dx=264,dy=256,dz=217,tag=!Indoors] unless entity @s[scores={Location=81}] run function kanto:triggers/stopsound

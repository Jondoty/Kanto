...
scoreboard players set @s[x=4581,y=11,z=852,dx=57,dy=23,dz=85,scores={MusicCooldown=0}] MusicCooldown 103

#Elite Four Bruno
playsound rocketgamecorner record @s[x=4581,y=11,z=937,dx=57,dy=23,dz=69,scores={MusicCooldown=0}] ~ ~ ~ 1 1 1
scoreboard players set @s[x=4581,y=11,z=937,dx=57,dy=23,dz=69,scores={MusicCooldown=0}] MusicCooldown 169

#Pokemon Tower
playsound pokemontower record @s[x=4581,y=11,z=1006,dx=57,dy=23,dz=69,scores={MusicCooldown=0}] ~ ~ ~ 1 1 1
scoreboard players set @s[x=4581,y=11,z=1006,dx=57,dy=23,dz=69,scores={MusicCooldown=0}] MusicCooldown 140
...
scoreboard players set @s[x=4581,y=11,z=1257,dx=57,dy=23,dz=54,scores={MusicCooldown=0}] MusicCooldown 93

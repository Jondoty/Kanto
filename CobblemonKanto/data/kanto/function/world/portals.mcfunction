...
execute as @s[x=2776,y=40,z=-2446,dx=4,dy=4] run function kanto:triggers/stopsound
tp @s[x=2776,y=40,z=-2446,dx=4,dy=4] 2809 -13 -2372

execute as @s[x=2807,y=-13,z=-2373,dx=4,dy=4] run function kanto:triggers/stopsound
tp @s[x=2807,y=-13,z=-2373,dx=4,dy=4] 2778 40 -2447

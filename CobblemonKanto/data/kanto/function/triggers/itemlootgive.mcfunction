...
execute as @s[x=3730,y=34,z=1505,distance=..4,tag=ItemLoot12] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3730,y=34,z=1505,distance=..4,tag=!ItemLoot12] run givetm dragonclaw @s
execute as @s[x=3730,y=34,z=1505,distance=..4,tag=!ItemLoot12] run tellraw @s {"text":"You found the TM Dragon Claw!","italic":true,"color":"gray"}
execute as @s[x=3730,y=34,z=1505,distance=..4,tag=!ItemLoot12] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3730,y=34,z=1505,distance=..4,tag=!ItemLoot12] run tag @s add ItemLoot12
...
execute as @s[x=3715,y=52,z=1476,distance=..4,tag=ItemLoot14] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3715,y=52,z=1476,distance=..4,tag=!ItemLoot14] run givetm sandstorm @s
execute as @s[x=3715,y=52,z=1476,distance=..4,tag=!ItemLoot14] run tellraw @s {"text":"You found the TM Sandstorm!","italic":true,"color":"gray"}
execute as @s[x=3715,y=52,z=1476,distance=..4,tag=!ItemLoot14] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3715,y=52,z=1476,distance=..4,tag=!ItemLoot14] run tag @s add ItemLoot14
...
execute as @s[x=3586,y=52,z=1512,distance=..4,tag=ItemLoot17] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3586,y=52,z=1512,distance=..4,tag=!ItemLoot17] run givetm hail @s
execute as @s[x=3586,y=52,z=1512,distance=..4,tag=!ItemLoot17] run tellraw @s {"text":"You found the TM Hail!","italic":true,"color":"gray"}
execute as @s[x=3586,y=52,z=1512,distance=..4,tag=!ItemLoot17] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3586,y=52,z=1512,distance=..4,tag=!ItemLoot17] run tag @s add ItemLoot17
...
execute as @s[x=3722,y=70,z=1493,distance=..4,tag=ItemLoot19] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3722,y=70,z=1493,distance=..4,tag=!ItemLoot19] run givetm overheat @s
execute as @s[x=3722,y=70,z=1493,distance=..4,tag=!ItemLoot19] run tellraw @s {"text":"You found the TM Overheat!","italic":true,"color":"gray"}
execute as @s[x=3722,y=70,z=1493,distance=..4,tag=!ItemLoot19] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3722,y=70,z=1493,distance=..4,tag=!ItemLoot19] run tag @s add ItemLoot19
...
execute as @s[x=2579,y=36,z=1858,distance=..4,tag=ItemLoot32] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2579,y=36,z=1858,distance=..4,tag=!ItemLoot32] run givetm bulletseed @s
execute as @s[x=2579,y=36,z=1858,distance=..4,tag=!ItemLoot32] run tellraw @s {"text":"You found the TM Bullet Seed!","italic":true,"color":"gray"}
execute as @s[x=2579,y=36,z=1858,distance=..4,tag=!ItemLoot32] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2579,y=36,z=1858,distance=..4,tag=!ItemLoot32] run tag @s add ItemLoot32
...
execute as @s[x=2457,y=41,z=1581,distance=..4,tag=ItemLoot44] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2457,y=41,z=1581,distance=..4,tag=!ItemLoot44] run givetm thief @s
execute as @s[x=2457,y=41,z=1581,distance=..4,tag=!ItemLoot44] run tellraw @s {"text":"You found the TM Thief!","italic":true,"color":"gray"}
execute as @s[x=2457,y=41,z=1581,distance=..4,tag=!ItemLoot44] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2457,y=41,z=1581,distance=..4,tag=!ItemLoot44] run tag @s add ItemLoot44
...
execute as @s[x=2566,y=46,z=1557,distance=..15,tag=Temp1,tag=ItemLoot48] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2566,y=46,z=1557,distance=..15,tag=Temp2,tag=ItemLoot48] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}

execute as @s[x=2566,y=46,z=1557,distance=..15,tag=!ItemLoot48] run advancement grant @s only kanto:mainquests/fossils

execute as @s[x=2566,y=46,z=1557,distance=..15,tag=Temp1,tag=!ItemLoot48] run give @s cobblemon:dome_fossil
execute as @s[x=2566,y=46,z=1557,distance=..15,tag=Temp1,tag=!ItemLoot48] run tellraw @s {"text":"You received a Dome Fossil!","italic":true,"color":"gray"}
execute as @s[x=2566,y=46,z=1557,distance=..15,tag=Temp1,tag=!ItemLoot48] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2566,y=46,z=1557,distance=..15,tag=Temp1,tag=!ItemLoot48] run tag @s add ItemLoot48
execute as @s[x=2566,y=46,z=1557,distance=..15] run tag @s remove Temp1

execute as @s[x=2566,y=46,z=1557,distance=..15,tag=Temp2,tag=!ItemLoot48] run give @s cobblemon:helix_fossil
execute as @s[x=2566,y=46,z=1557,distance=..15,tag=Temp2,tag=!ItemLoot48] run tellraw @s {"text":"You received a Helix Fossil!","italic":true,"color":"gray"}
execute as @s[x=2566,y=46,z=1557,distance=..15,tag=Temp2,tag=!ItemLoot48] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2566,y=46,z=1557,distance=..15,tag=Temp2,tag=!ItemLoot48] run tag @s add ItemLoot48
execute as @s[x=2566,y=46,z=1557,distance=..15] run tag @s remove Temp2
...
execute as @s[x=3421,y=34,z=903,distance=..4,tag=ItemLoot54] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3421,y=34,z=903,distance=..4,tag=!ItemLoot54] run givetm roar @s
execute as @s[x=3421,y=34,z=903,distance=..4,tag=!ItemLoot54] run tellraw @s {"text":"You found the TM Roar!","italic":true,"color":"gray"}
execute as @s[x=3421,y=34,z=903,distance=..4,tag=!ItemLoot54] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3421,y=34,z=903,distance=..4,tag=!ItemLoot54] run tag @s add ItemLoot54
...
execute as @s[x=3107,y=34,z=1154,distance=..4,tag=ItemLoot62] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3107,y=34,z=1154,distance=..4,tag=!ItemLoot62] run givetm attract @s
execute as @s[x=3107,y=34,z=1154,distance=..4,tag=!ItemLoot62] run tellraw @s {"text":"You found the TM Attract!","italic":true,"color":"gray"}
execute as @s[x=3107,y=34,z=1154,distance=..4,tag=!ItemLoot62] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3107,y=34,z=1154,distance=..4,tag=!ItemLoot62] run tag @s add ItemLoot62
...
execute as @s[x=2917,y=34,z=1163,distance=..4,tag=ItemLoot65] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2917,y=34,z=1163,distance=..4,tag=!ItemLoot65] run givetm secretpower @s
execute as @s[x=2917,y=34,z=1163,distance=..4,tag=!ItemLoot65] run tellraw @s {"text":"You found the TM Secret Power!","italic":true,"color":"gray"}
execute as @s[x=2917,y=34,z=1163,distance=..4,tag=!ItemLoot65] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2917,y=34,z=1163,distance=..4,tag=!ItemLoot65] run tag @s add ItemLoot65
...
execute as @s[x=2926,y=34,z=849,distance=..4,tag=ItemLoot70] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2926,y=34,z=849,distance=..4,tag=!ItemLoot70] run givetm aerialace @s
execute as @s[x=2926,y=34,z=849,distance=..4,tag=!ItemLoot70] run tellraw @s {"text":"You found the TM Aerial Ace!","italic":true,"color":"gray"}
execute as @s[x=2926,y=34,z=849,distance=..4,tag=!ItemLoot70] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2926,y=34,z=849,distance=..4,tag=!ItemLoot70] run tag @s add ItemLoot70
...
execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27,tag=Temp2,tag=ItemLoot115] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27,tag=Temp1,tag=ItemLoot115] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}

execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27,tag=Temp1,tag=!ItemLoot115] run pokegive hitmonchan level=25
execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27,tag=Temp1,tag=!ItemLoot115] run tellraw @s {"text":"You received a Hitmonchan!","italic":true,"color":"gray"}
execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27,tag=Temp1,tag=!ItemLoot115] run playsound getpokemon ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27,tag=Temp1,tag=!ItemLoot115] run tag @s add ItemLoot115
execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27] run tag @s remove Temp1

execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27,tag=Temp2,tag=!ItemLoot115] run pokegive hitmonlee level=25
execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27,tag=Temp2,tag=!ItemLoot115] run tellraw @s {"text":"You received a Hitmonlee!","italic":true,"color":"gray"}
execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27,tag=Temp2,tag=!ItemLoot115] run playsound getpokemon ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27,tag=Temp2,tag=!ItemLoot115] run tag @s add ItemLoot115
execute as @s[x=3051,y=-11,z=565,dx=23,dy=10,dz=27] run tag @s remove Temp2

#Silph Co
#Each loot has two locations, both in a taken over Rocket version or a normal version, but share the same data of if claimed
...
execute as @s[x=4459,y=49,z=1947,distance=..4,tag=ItemLoot118] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4459,y=49,z=1947,distance=..4,tag=!ItemLoot118] run give @s cobblemon:ultra_ball
execute as @s[x=4459,y=49,z=1947,distance=..4,tag=!ItemLoot118] run tellraw @s {"text":"You found an Ultra Ball!","italic":true,"color":"gray"}
execute as @s[x=4459,y=49,z=1947,distance=..4,tag=!ItemLoot118] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4459,y=49,z=1947,distance=..4,tag=!ItemLoot118] run tag @s add ItemLoot118
...
execute as @s[x=4462,y=62,z=1973,distance=..4,tag=ItemLoot119] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4462,y=62,z=1973,distance=..4,tag=!ItemLoot119] run give @s cobblemon:hyper_potion
execute as @s[x=4462,y=62,z=1973,distance=..4,tag=!ItemLoot119] run tellraw @s {"text":"You found a Hyper Potion!","italic":true,"color":"gray"}
execute as @s[x=4462,y=62,z=1973,distance=..4,tag=!ItemLoot119] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4462,y=62,z=1973,distance=..4,tag=!ItemLoot119] run tag @s add ItemLoot119
...
execute as @s[x=4392,y=62,z=1949,distance=..4,tag=ItemLoot120] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4392,y=62,z=1949,distance=..4,tag=!ItemLoot120] run give @s cobblemon:protein
execute as @s[x=4392,y=62,z=1949,distance=..4,tag=!ItemLoot120] run tellraw @s {"text":"You found a Protein!","italic":true,"color":"gray"}
execute as @s[x=4392,y=62,z=1949,distance=..4,tag=!ItemLoot120] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4392,y=62,z=1949,distance=..4,tag=!ItemLoot120] run tag @s add ItemLoot120
...
execute as @s[x=4487,y=75,z=1990,distance=..4,tag=ItemLoot121] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4487,y=75,z=1990,distance=..4,tag=!ItemLoot121] run give @s cobblemon:full_heal
execute as @s[x=4487,y=75,z=1990,distance=..4,tag=!ItemLoot121] run tellraw @s {"text":"You found a Full Heal!","italic":true,"color":"gray"}
execute as @s[x=4487,y=75,z=1990,distance=..4,tag=!ItemLoot121] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4487,y=75,z=1990,distance=..4,tag=!ItemLoot121] run tag @s add ItemLoot121
...
execute as @s[x=4480,y=75,z=1973,distance=..4,tag=ItemLoot122] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4480,y=75,z=1973,distance=..4,tag=!ItemLoot122] run give @s minecraft:ender_eye
execute as @s[x=4480,y=75,z=1973,distance=..4,tag=!ItemLoot122] run tellraw @s {"text":"You found an Escape Rope!","italic":true,"color":"gray"}
execute as @s[x=4480,y=75,z=1973,distance=..4,tag=!ItemLoot122] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4480,y=75,z=1973,distance=..4,tag=!ItemLoot122] run tag @s add ItemLoot122


execute as @s[x=4464,y=75,z=1963,distance=..4,tag=ItemLoot123] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4464,y=75,z=1963,distance=..4,tag=!ItemLoot123] run give @s cobblemon:max_revive
execute as @s[x=4464,y=75,z=1963,distance=..4,tag=!ItemLoot123] run tellraw @s {"text":"You found a Max Revive!","italic":true,"color":"gray"}
execute as @s[x=4464,y=75,z=1963,distance=..4,tag=!ItemLoot123] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4464,y=75,z=1963,distance=..4,tag=!ItemLoot123] run tag @s add ItemLoot123

execute as @s[x=4399,y=75,z=1945,distance=..4,tag=ItemLoot124] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4399,y=75,z=1802,distance=..4,tag=ItemLoot124] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4399,y=75,z=1945,distance=..4,tag=!ItemLoot124] run givetm torment @s
execute as @s[x=4399,y=75,z=1945,distance=..4,tag=!ItemLoot124] run tellraw @s {"text":"You found the TM Torment!","italic":true,"color":"gray"}
execute as @s[x=4399,y=75,z=1945,distance=..4,tag=!ItemLoot124] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4399,y=75,z=1945,distance=..4,tag=!ItemLoot124] run tag @s add ItemLoot124

execute as @s[x=4399,y=75,z=1802,distance=..4,tag=!ItemLoot124] run givetm torment @s
execute as @s[x=4399,y=75,z=1802,distance=..4,tag=!ItemLoot124] run tellraw @s {"text":"You found the TM Torment!","italic":true,"color":"gray"}
execute as @s[x=4399,y=75,z=1802,distance=..4,tag=!ItemLoot124] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4399,y=75,z=1802,distance=..4,tag=!ItemLoot124] run tag @s add ItemLoot124
...
execute as @s[x=4459,y=75,z=1951,distance=..4,tag=ItemLoot125] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4459,y=75,z=1951,distance=..4,tag=!ItemLoot125] run give @s cobblemon:iron
execute as @s[x=4459,y=75,z=1951,distance=..4,tag=!ItemLoot125] run tellraw @s {"text":"You found an Iron!","italic":true,"color":"gray"}
execute as @s[x=4459,y=75,z=1951,distance=..4,tag=!ItemLoot125] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4459,y=75,z=1951,distance=..4,tag=!ItemLoot125] run tag @s add ItemLoot125
...
execute as @s[x=4440,y=88,z=1944,distance=..4,tag=ItemLoot126] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4440,y=88,z=1944,distance=..4,tag=!ItemLoot126] run tag @s add CardKey
execute as @s[x=4440,y=88,z=1944,distance=..4,tag=!ItemLoot126] run tellraw @s {"text":"You found a Card Key!","italic":true,"color":"gray"}
execute as @s[x=4440,y=88,z=1944,distance=..4,tag=!ItemLoot126] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4440,y=88,z=1944,distance=..4,tag=!ItemLoot126] run tag @s add ItemLoot126
...
execute as @s[x=4480,y=88,z=1975,distance=..4,tag=ItemLoot127] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4480,y=88,z=1975,distance=..4,tag=!ItemLoot127] run give @s cobblemon:protein
execute as @s[x=4480,y=88,z=1975,distance=..4,tag=!ItemLoot127] run tellraw @s {"text":"You found a Protein!","italic":true,"color":"gray"}
execute as @s[x=4480,y=88,z=1975,distance=..4,tag=!ItemLoot127] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4480,y=88,z=1975,distance=..4,tag=!ItemLoot127] run tag @s add ItemLoot127


execute as @s[x=4483,y=88,z=1952,distance=..4,tag=ItemLoot128] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4483,y=88,z=1809,distance=..4,tag=ItemLoot128] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4483,y=88,z=1952,distance=..4,tag=!ItemLoot128] run givetm focuspunch @s
execute as @s[x=4483,y=88,z=1952,distance=..4,tag=!ItemLoot128] run tellraw @s {"text":"You found the TM Focus Punch!","italic":true,"color":"gray"}
execute as @s[x=4483,y=88,z=1952,distance=..4,tag=!ItemLoot128] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4483,y=88,z=1952,distance=..4,tag=!ItemLoot128] run tag @s add ItemLoot128

execute as @s[x=4483,y=88,z=1809,distance=..4,tag=!ItemLoot128] run givetm focuspunch @s
execute as @s[x=4483,y=88,z=1809,distance=..4,tag=!ItemLoot128] run tellraw @s {"text":"You found the TM Focus Punch!","italic":true,"color":"gray"}
execute as @s[x=4483,y=88,z=1809,distance=..4,tag=!ItemLoot128] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4483,y=88,z=1809,distance=..4,tag=!ItemLoot128] run tag @s add ItemLoot128
...
execute as @s[x=4396,y=88,z=1949,distance=..4,tag=ItemLoot129] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4396,y=88,z=1949,distance=..4,tag=!ItemLoot129] run give @s cobblemon:pp_up
execute as @s[x=4396,y=88,z=1949,distance=..4,tag=!ItemLoot129] run tellraw @s {"text":"You found a PP Up!","italic":true,"color":"gray"}
execute as @s[x=4396,y=88,z=1949,distance=..4,tag=!ItemLoot129] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4396,y=88,z=1949,distance=..4,tag=!ItemLoot129] run tag @s add ItemLoot129
...
execute as @s[x=4450,y=88,z=1949,distance=..4,tag=ItemLoot130] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4450,y=88,z=1949,distance=..4,tag=!ItemLoot130] run give @s cobblemon:elixir
execute as @s[x=4450,y=88,z=1949,distance=..4,tag=!ItemLoot130] run tellraw @s {"text":"You found an Elixir!","italic":true,"color":"gray"}
execute as @s[x=4450,y=88,z=1949,distance=..4,tag=!ItemLoot130] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4450,y=88,z=1949,distance=..4,tag=!ItemLoot130] run tag @s add ItemLoot130
...
execute as @s[x=4471,y=101,z=1962,distance=..4,tag=ItemLoot131] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4471,y=101,z=1962,distance=..4,tag=!ItemLoot131] run give @s cobblemon:hp_up
execute as @s[x=4471,y=101,z=1962,distance=..4,tag=!ItemLoot131] run tellraw @s {"text":"You found a HP Up!","italic":true,"color":"gray"}
execute as @s[x=4471,y=101,z=1962,distance=..4,tag=!ItemLoot131] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4471,y=101,z=1962,distance=..4,tag=!ItemLoot131] run tag @s add ItemLoot131
...
execute as @s[x=4473,y=102,z=1979,distance=..4,tag=ItemLoot132] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4473,y=102,z=1979,distance=..4,tag=!ItemLoot132] run give @s cobblemon:carbos
execute as @s[x=4473,y=102,z=1979,distance=..4,tag=!ItemLoot132] run tellraw @s {"text":"You found a Carbos!","italic":true,"color":"gray"}
execute as @s[x=4473,y=102,z=1979,distance=..4,tag=!ItemLoot132] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4473,y=102,z=1979,distance=..4,tag=!ItemLoot132] run tag @s add ItemLoot132
...
execute as @s[x=4476,y=101,z=1951,distance=..4,tag=ItemLoot133] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4476,y=101,z=1951,distance=..4,tag=!ItemLoot133] run give @s cobblemon:x_special_defence
execute as @s[x=4476,y=101,z=1951,distance=..4,tag=!ItemLoot133] run tellraw @s {"text":"You found an X Special!","italic":true,"color":"gray"}
execute as @s[x=4476,y=101,z=1951,distance=..4,tag=!ItemLoot133] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4476,y=101,z=1951,distance=..4,tag=!ItemLoot133] run tag @s add ItemLoot133
...
execute as @s[x=4440,y=114,z=1816,distance=..4,tag=ItemLoot134] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4440,y=114,z=1816,distance=..4,tag=!ItemLoot134] run give @s cobblemon:calcium
execute as @s[x=4440,y=114,z=1816,distance=..4,tag=!ItemLoot134] run tellraw @s {"text":"You found a Calcium!","italic":true,"color":"gray"}
execute as @s[x=4440,y=114,z=1816,distance=..4,tag=!ItemLoot134] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4440,y=114,z=1816,distance=..4,tag=!ItemLoot134] run tag @s add ItemLoot134


execute as @s[x=4392,y=114,z=1967,distance=..4,tag=ItemLoot135] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4392,y=114,z=1824,distance=..4,tag=ItemLoot135] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4392,y=114,z=1967,distance=..4,tag=!ItemLoot135] run givetm bulkup @s
execute as @s[x=4392,y=114,z=1967,distance=..4,tag=!ItemLoot135] run tellraw @s {"text":"You found the TM Bulk Up!","italic":true,"color":"gray"}
execute as @s[x=4392,y=114,z=1967,distance=..4,tag=!ItemLoot135] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4392,y=114,z=1967,distance=..4,tag=!ItemLoot135] run tag @s add ItemLoot135

execute as @s[x=4392,y=114,z=1824,distance=..4,tag=!ItemLoot135] run givetm bulkup @s
execute as @s[x=4392,y=114,z=1824,distance=..4,tag=!ItemLoot135] run tellraw @s {"text":"You found the TM Bulk Up!","italic":true,"color":"gray"}
execute as @s[x=4392,y=114,z=1824,distance=..4,tag=!ItemLoot135] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4392,y=114,z=1824,distance=..4,tag=!ItemLoot135] run tag @s add ItemLoot135


execute as @s[x=4394,y=114,z=1805,distance=..4,tag=ItemLoot136] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4394,y=114,z=1805,distance=..4,tag=!ItemLoot136] run give @s cobblemon:zinc
execute as @s[x=4394,y=114,z=1805,distance=..4,tag=!ItemLoot136] run tellraw @s {"text":"You found a Zinc!","italic":true,"color":"gray"}
execute as @s[x=4394,y=114,z=1805,distance=..4,tag=!ItemLoot136] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4394,y=114,z=1805,distance=..4,tag=!ItemLoot136] run tag @s add ItemLoot136


execute as @s[x=4401,y=127,z=1835,distance=..4,tag=ItemLoot137] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4401,y=127,z=1835,distance=..4,tag=!ItemLoot137] run give @s cobblemon:iron
execute as @s[x=4401,y=127,z=1835,distance=..4,tag=!ItemLoot137] run tellraw @s {"text":"You found an Iron!","italic":true,"color":"gray"}
execute as @s[x=4401,y=127,z=1835,distance=..4,tag=!ItemLoot137] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4401,y=127,z=1835,distance=..4,tag=!ItemLoot137] run tag @s add ItemLoot137


execute as @s[x=4389,y=127,z=1813,distance=..4,tag=ItemLoot138] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4389,y=127,z=1813,distance=..4,tag=!ItemLoot138] run scoreboard players add @s Money 5000
execute as @s[x=4389,y=127,z=1813,distance=..4,tag=!ItemLoot138] run tellraw @s {"text":"You found $5,000!","italic":true,"color":"gray"}
execute as @s[x=4389,y=127,z=1813,distance=..4,tag=!ItemLoot138] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4389,y=127,z=1813,distance=..4,tag=!ItemLoot138] run tag @s add ItemLoot138


execute as @s[x=4415,y=140,z=1826,distance=..4,tag=ItemLoot139] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4415,y=140,z=1826,distance=..4,tag=!ItemLoot139] run give @s cobblemon:max_potion
execute as @s[x=4415,y=140,z=1826,distance=..4,tag=!ItemLoot139] run tellraw @s {"text":"You found a Max Potion!","italic":true,"color":"gray"}
execute as @s[x=4415,y=140,z=1826,distance=..4,tag=!ItemLoot139] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4415,y=140,z=1826,distance=..4,tag=!ItemLoot139] run tag @s add ItemLoot139


execute as @s[x=4438,y=140,z=1841,distance=..4,tag=ItemLoot140] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4438,y=140,z=1841,distance=..4,tag=!ItemLoot140] run give @s cobblemon:calcium
execute as @s[x=4438,y=140,z=1841,distance=..4,tag=!ItemLoot140] run tellraw @s {"text":"You found a Calcium!","italic":true,"color":"gray"}
execute as @s[x=4438,y=140,z=1841,distance=..4,tag=!ItemLoot140] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4438,y=140,z=1841,distance=..4,tag=!ItemLoot140] run tag @s add ItemLoot140


execute as @s[x=4430,y=153,z=1812,distance=..4,tag=ItemLoot141] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4430,y=153,z=1812,distance=..4,tag=!ItemLoot141] run give @s cobblemon:rare_candy
execute as @s[x=4430,y=153,z=1812,distance=..4,tag=!ItemLoot141] run tellraw @s {"text":"You found a Rare Candy!","italic":true,"color":"gray"}
execute as @s[x=4430,y=153,z=1812,distance=..4,tag=!ItemLoot141] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4430,y=153,z=1812,distance=..4,tag=!ItemLoot141] run tag @s add ItemLoot141


execute as @s[x=4425,y=153,z=1815,distance=..4,tag=ItemLoot142] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4425,y=153,z=1815,distance=..4,tag=!ItemLoot142] run give @s cobblemon:carbos
execute as @s[x=4425,y=153,z=1815,distance=..4,tag=!ItemLoot142] run tellraw @s {"text":"You found a Carbos!","italic":true,"color":"gray"}
execute as @s[x=4425,y=153,z=1815,distance=..4,tag=!ItemLoot142] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4425,y=153,z=1815,distance=..4,tag=!ItemLoot142] run tag @s add ItemLoot142


execute as @s[x=4397,y=153,z=1824,distance=..4,tag=ItemLoot143] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4397,y=153,z=1824,distance=..4,tag=!ItemLoot143] run give @s cobblemon:hp_up
execute as @s[x=4397,y=153,z=1824,distance=..4,tag=!ItemLoot143] run tellraw @s {"text":"You found an HP Up!","italic":true,"color":"gray"}
execute as @s[x=4397,y=153,z=1824,distance=..4,tag=!ItemLoot143] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4397,y=153,z=1824,distance=..4,tag=!ItemLoot143] run tag @s add ItemLoot143


execute as @s[x=4433,y=153,z=1815,distance=..4,tag=ItemLoot144] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4433,y=153,z=1815,distance=..4,tag=!ItemLoot144] run give @s cobblemon:ultra_ball
execute as @s[x=4433,y=153,z=1815,distance=..4,tag=!ItemLoot144] run tellraw @s {"text":"You found an Ultra Ball!","italic":true,"color":"gray"}
...
execute as @s[x=4398,y=166,z=1805,distance=..4,tag=!ItemLoot146] run give @s cobblemon:zinc
execute as @s[x=4398,y=166,z=1805,distance=..4,tag=!ItemLoot146] run tellraw @s {"text":"You found a Zinc!","italic":true,"color":"gray"}
execute as @s[x=4398,y=166,z=1805,distance=..4,tag=!ItemLoot146] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4398,y=166,z=1805,distance=..4,tag=!ItemLoot146] run tag @s add ItemLoot146


execute as @s[x=4409,y=166,z=1807,distance=..4,tag=ItemLoot147] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4409,y=166,z=1807,distance=..4,tag=!ItemLoot147] run give @s cobblemon:revive
execute as @s[x=4409,y=166,z=1807,distance=..4,tag=!ItemLoot147] run tellraw @s {"text":"You found a Revive!","italic":true,"color":"gray"}
execute as @s[x=4409,y=166,z=1807,distance=..4,tag=!ItemLoot147] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4409,y=166,z=1807,distance=..4,tag=!ItemLoot147] run tag @s add ItemLoot147
...
execute as @s[x=4654,y=70,z=1679,distance=..4,tag=ItemLoot161] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4654,y=70,z=1679,distance=..4,tag=!ItemLoot161] run givetm taunt @s
execute as @s[x=4654,y=70,z=1679,distance=..4,tag=!ItemLoot161] run tellraw @s {"text":"You found the TM Taunt!","italic":true,"color":"gray"}
execute as @s[x=4654,y=70,z=1679,distance=..4,tag=!ItemLoot161] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4654,y=70,z=1679,distance=..4,tag=!ItemLoot161] run tag @s add ItemLoot161
...
execute as @s[x=4624,y=50,z=1664,distance=..4,tag=ItemLoot163] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4624,y=50,z=1664,distance=..4,tag=!ItemLoot163] run givetm frustration @s
execute as @s[x=4624,y=50,z=1664,distance=..4,tag=!ItemLoot163] run tellraw @s {"text":"You found the TM Frustration!","italic":true,"color":"gray"}
execute as @s[x=4624,y=50,z=1664,distance=..4,tag=!ItemLoot163] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4624,y=50,z=1664,distance=..4,tag=!ItemLoot163] run tag @s add ItemLoot163
...
execute as @s[x=4664,y=35,z=1678,distance=..4,tag=ItemLoot168] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4664,y=35,z=1678,distance=..4,tag=!ItemLoot168] run givetm snatch @s
execute as @s[x=4664,y=35,z=1678,distance=..4,tag=!ItemLoot168] run tellraw @s {"text":"You found the TM Snatch!","italic":true,"color":"gray"}
execute as @s[x=4664,y=35,z=1678,distance=..4,tag=!ItemLoot168] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4664,y=35,z=1678,distance=..4,tag=!ItemLoot168] run tag @s add ItemLoot168
...
execute as @s[x=3818,y=35,z=511,distance=..4,tag=!ItemLoot175] run givetm fly @s
...
execute as @s[x=3408,y=35,z=-442,distance=..4,tag=ItemLoot183] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3408,y=35,z=-442,distance=..4,tag=!ItemLoot183] run givetm strength @s
execute as @s[x=3408,y=35,z=-442,distance=..4,tag=!ItemLoot183] run tellraw @s {"text":"You recieved a Strength TM!","italic":true,"color":"gray"}
execute as @s[x=3408,y=35,z=-442,distance=..4,tag=!ItemLoot183] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3408,y=35,z=-442,distance=..4,tag=!ItemLoot183] run tag @s add ItemLoot183
...
execute as @s[x=3260,y=34,z=-217,distance=..4,tag=ItemLoot189] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3260,y=34,z=-217,distance=..4,tag=!ItemLoot189] run givetm sunnyday @s
execute as @s[x=3260,y=34,z=-217,distance=..4,tag=!ItemLoot189] run tellraw @s {"text":"You found the TM Sunny Day!","italic":true,"color":"gray"}
execute as @s[x=3260,y=34,z=-217,distance=..4,tag=!ItemLoot189] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3260,y=34,z=-217,distance=..4,tag=!ItemLoot189] run tag @s add ItemLoot189
...
execute as @s[x=3461,y=34,z=-74,distance=..4,tag=ItemLoot193] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3461,y=34,z=-74,distance=..4,tag=!ItemLoot193] run givetm steelwing @s
execute as @s[x=3461,y=34,z=-74,distance=..4,tag=!ItemLoot193] run tellraw @s {"text":"You found the TM Steel Wing!","italic":true,"color":"gray"}
execute as @s[x=3461,y=34,z=-74,distance=..4,tag=!ItemLoot193] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3461,y=34,z=-74,distance=..4,tag=!ItemLoot193] run tag @s add ItemLoot193
...
execute as @s[x=3658,y=34,z=-196,distance=..4,tag=ItemLoot197] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3658,y=34,z=-196,distance=..4,tag=!ItemLoot197] run givetm doubleteam @s
execute as @s[x=3658,y=34,z=-196,distance=..4,tag=!ItemLoot197] run tellraw @s {"text":"You found the TM Double Team!","italic":true,"color":"gray"}
execute as @s[x=3658,y=34,z=-196,distance=..4,tag=!ItemLoot197] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3658,y=34,z=-196,distance=..4,tag=!ItemLoot197] run tag @s add ItemLoot197
...
execute as @s[x=3676,y=34,z=-171,distance=..4,tag=!ItemLoot198] run givetm surf @s
...
execute as @s[x=3616,y=34,z=-209,distance=..4,tag=ItemLoot200] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3616,y=34,z=-209,distance=..4,tag=!ItemLoot200] run function kanto:spawn/goldteeth
execute as @s[x=3616,y=34,z=-209,distance=..4,tag=!ItemLoot200] run tellraw @s {"text":"You found Gold Teeth!","italic":true,"color":"gray"}
execute as @s[x=3616,y=34,z=-209,distance=..4,tag=!ItemLoot200] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3616,y=34,z=-209,distance=..4,tag=!ItemLoot200] run tag @s add ItemLoot200

execute as @s[x=3241,y=34,z=-374,distance=..4,tag=ItemLoot201] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3241,y=34,z=-374,distance=..4,tag=!ItemLoot201] run givetm raindance @s
execute as @s[x=3241,y=34,z=-374,distance=..4,tag=!ItemLoot201] run tellraw @s {"text":"You found the TM Rain Dance!","italic":true,"color":"gray"}
execute as @s[x=3241,y=34,z=-374,distance=..4,tag=!ItemLoot201] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3241,y=34,z=-374,distance=..4,tag=!ItemLoot201] run tag @s add ItemLoot201
...
execute as @s[x=2566,y=35,z=345,distance=..4,tag=ItemLoot206] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2566,y=35,z=345,distance=..4,tag=!ItemLoot206] run givetm return @s
execute as @s[x=2566,y=35,z=345,distance=..4,tag=!ItemLoot206] run tellraw @s {"text":"You received Return!!","italic":true,"color":"gray"}
execute as @s[x=2566,y=35,z=345,distance=..4,tag=!ItemLoot206] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2566,y=35,z=345,distance=..4,tag=!ItemLoot206] run tag @s add ItemLoot206

execute as @s[x=2541,y=34,z=266,distance=..4,tag=ItemLoot207] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=2541,y=34,z=266,distance=..4,tag=!ItemLoot207] run givetm skillswap @s
execute as @s[x=2541,y=34,z=266,distance=..4,tag=!ItemLoot207] run tellraw @s {"text":"You found the TM Skill Swap!","italic":true,"color":"gray"}
execute as @s[x=2541,y=34,z=266,distance=..4,tag=!ItemLoot207] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=2541,y=34,z=266,distance=..4,tag=!ItemLoot207] run tag @s add ItemLoot207
...
execute as @s[x=3132,y=42,z=-12,distance=..4,tag=ItemLoot226] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3132,y=42,z=-12,distance=..4,tag=!ItemLoot226] run givetm rest @s
execute as @s[x=3132,y=42,z=-12,distance=..4,tag=!ItemLoot226] run tellraw @s {"text":"You found the TM Rest!","italic":true,"color":"gray"}
execute as @s[x=3132,y=42,z=-12,distance=..4,tag=!ItemLoot226] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3132,y=42,z=-12,distance=..4,tag=!ItemLoot226] run tag @s add ItemLoot226
...
execute as @s[x=3146,y=47,z=-26,distance=..4,tag=ItemLoot233] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3146,y=47,z=-26,distance=..4,tag=!ItemLoot233] run givetm brickbreak @s
execute as @s[x=3146,y=47,z=-26,distance=..4,tag=!ItemLoot233] run tellraw @s {"text":"You found the TM Brick Break!","italic":true,"color":"gray"}
execute as @s[x=3146,y=47,z=-26,distance=..4,tag=!ItemLoot233] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3146,y=47,z=-26,distance=..4,tag=!ItemLoot233] run tag @s add ItemLoot233
...
execute as @s[x=3963,y=35,z=1766,distance=..4,tag=ItemLoot257] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3963,y=35,z=1766,distance=..4,tag=!ItemLoot257] run givetm blizzard @s
execute as @s[x=3963,y=35,z=1766,distance=..4,tag=!ItemLoot257] run tellraw @s {"text":"You found the TM Blizzard!","italic":true,"color":"gray"}
execute as @s[x=3963,y=35,z=1766,distance=..4,tag=!ItemLoot257] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3963,y=35,z=1766,distance=..4,tag=!ItemLoot257] run tag @s add ItemLoot257
...
execute as @s[x=4021,y=35,z=1705,distance=..4,tag=ItemLoot259] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4021,y=35,z=1705,distance=..4,tag=!ItemLoot259] run givetm solarbeam @s
execute as @s[x=4021,y=35,z=1705,distance=..4,tag=!ItemLoot259] run tellraw @s {"text":"You found the TM SolarBeam!","italic":true,"color":"gray"}
execute as @s[x=4021,y=35,z=1705,distance=..4,tag=!ItemLoot259] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4021,y=35,z=1705,distance=..4,tag=!ItemLoot259] run tag @s add ItemLoot259
...
execute as @s[x=4686,y=35,z=1827,distance=..4,tag=ItemLoot399] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4686,y=35,z=1827,distance=..4,tag=!ItemLoot399] run givetm thunder @s
execute as @s[x=4686,y=35,z=1827,distance=..4,tag=!ItemLoot399] run tellraw @s {"text":"You found the TM Thunder!","italic":true,"color":"gray"}
execute as @s[x=4686,y=35,z=1827,distance=..4,tag=!ItemLoot399] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4686,y=35,z=1827,distance=..4,tag=!ItemLoot399] run tag @s add ItemLoot399
...
execute as @s[x=4656,y=35,z=1880,distance=..4,tag=ItemLoot400] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4656,y=35,z=1880,distance=..4,tag=!ItemLoot400] run givetm protect @s
execute as @s[x=4656,y=35,z=1880,distance=..4,tag=!ItemLoot400] run tellraw @s {"text":"You found the TM Protect!","italic":true,"color":"gray"}
execute as @s[x=4656,y=35,z=1880,distance=..4,tag=!ItemLoot400] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4656,y=35,z=1880,distance=..4,tag=!ItemLoot400] run tag @s add ItemLoot400
...
execute as @s[x=3993,y=44,z=1564,distance=..4,tag=!ItemLoot289] run givetm rocksmash
execute as @s[x=3993,y=44,z=1564,distance=..4,tag=!ItemLoot289] run tellraw @s {"text":"You recieved HM06 (Rock Smash)! You can now click on rocks to break them.","italic":true,"color":"gray"}
...
#347 - Selphy's rewards

#348-352 Lost Cave
#execute as @s[x=4129,y=34,z=1671,distance=..4,tag=ItemLoot348] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
#execute as @s[x=4129,y=34,z=1671,distance=..4,tag=!ItemLoot348] run give @s cobblemon:lax_incense
#execute as @s[x=4129,y=34,z=1671,distance=..4,tag=!ItemLoot348] run tellraw @s {"text":"You found an Lax Incense!","italic":true,"color":"gray"}
#execute as @s[x=4129,y=34,z=1671,distance=..4,tag=!ItemLoot348] run playsound getitem ambient @s ~ ~ ~ 1 1 1
#execute as @s[x=4129,y=34,z=1671,distance=..4,tag=!ItemLoot348] run tag @s add ItemLoot348

#execute as @s[x=4172,y=34,z=1596,distance=..4,tag=ItemLoot349] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
#execute as @s[x=4172,y=34,z=1596,distance=..4,tag=!ItemLoot349] run give @s cobblemon:sea_incense
#execute as @s[x=4172,y=34,z=1596,distance=..4,tag=!ItemLoot349] run tellraw @s {"text":"You found an Sea Incense!","italic":true,"color":"gray"}
#execute as @s[x=4172,y=34,z=1596,distance=..4,tag=!ItemLoot349] run playsound getitem ambient @s ~ ~ ~ 1 1 1
#execute as @s[x=4172,y=34,z=1596,distance=..4,tag=!ItemLoot349] run tag @s add ItemLoot349

execute as @s[x=4260,y=34,z=1672,distance=..4,tag=ItemLoot350] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4260,y=34,z=1672,distance=..4,tag=!ItemLoot350] run give @s cobblemon:max_revive
execute as @s[x=4260,y=34,z=1672,distance=..4,tag=!ItemLoot350] run tellraw @s {"text":"You found an Max Revive!","italic":true,"color":"gray"}
execute as @s[x=4260,y=34,z=1672,distance=..4,tag=!ItemLoot350] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4260,y=34,z=1672,distance=..4,tag=!ItemLoot350] run tag @s add ItemLoot350

execute as @s[x=4214,y=34,z=1634,distance=..4,tag=ItemLoot351] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4214,y=34,z=1634,distance=..4,tag=!ItemLoot351] run give @s cobblemon:rare_candy
execute as @s[x=4214,y=34,z=1634,distance=..4,tag=!ItemLoot351] run tellraw @s {"text":"You found an Rare Candy!","italic":true,"color":"gray"}
execute as @s[x=4214,y=34,z=1634,distance=..4,tag=!ItemLoot351] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4214,y=34,z=1634,distance=..4,tag=!ItemLoot351] run tag @s add ItemLoot351

execute as @s[x=4306,y=34,z=1590,distance=..4,tag=ItemLoot352] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=4306,y=34,z=1590,distance=..4,tag=!ItemLoot352] run give @s cobblemon:silk_scarf
execute as @s[x=4306,y=34,z=1590,distance=..4,tag=!ItemLoot352] run tellraw @s {"text":"You found a Silk Scarf!","italic":true,"color":"gray"}
execute as @s[x=4306,y=34,z=1590,distance=..4,tag=!ItemLoot352] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4306,y=34,z=1590,distance=..4,tag=!ItemLoot352] run tag @s add ItemLoot352
...
execute as @s[x=3091,y=-7,z=-2991,distance=..4,tag=ItemLoot357] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
execute as @s[x=3091,y=-7,z=-2991,distance=..4,tag=!ItemLoot357] run givetm sludgebomb @s
execute as @s[x=3091,y=-7,z=-2991,distance=..4,tag=!ItemLoot357] run tellraw @s {"text":"You found the TM Sludge Bomb!","italic":true,"color":"gray"}
execute as @s[x=3091,y=-7,z=-2991,distance=..4,tag=!ItemLoot357] run playsound getitem ambient @s ~ ~ ~ 1 1 1
execute as @s[x=3091,y=-7,z=-2991,distance=..4,tag=!ItemLoot357] run tag @s add ItemLoot357
...
execute as @s[x=4474,y=114,z=1981,distance=..4,tag=ItemLoot395] run tellraw @s {"text":"You've already claimed this loot!","italic":true,"color":"gray"}
...
execute as @s[x=4474,y=114,z=1981,distance=..4,tag=!ItemLoot395] run pokegive lapras level=15
execute as @s[x=4474,y=114,z=1981,distance=..4,tag=!ItemLoot395] run tellraw @s {"text":"You received a Lapras!","italic":true,"color":"gray"}
execute as @s[x=4474,y=114,z=1981,distance=..4,tag=!ItemLoot395] run playsound getpokemon ambient @s ~ ~ ~ 1 1 1
execute as @s[x=4474,y=114,z=1981,distance=..4,tag=!ItemLoot395] run scoreboard players add @s PokeDex 1
execute as @s[x=4474,y=114,z=1981,distance=..4,tag=!ItemLoot395] run tag @s add ItemLoot395

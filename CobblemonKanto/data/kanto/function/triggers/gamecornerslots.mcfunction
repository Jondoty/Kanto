...
execute as @s[tag=Machine1Roll,scores={TalkTime=0,rng=1..3}] run clone 3905 41 1221 3905 43 1223 3473 35 488
execute as @s[tag=Machine1Roll,scores={TalkTime=0,rng=4..10}] run clone 3900 41 1221 3900 43 1223 3473 35 488
execute as @s[tag=Machine1Roll,scores={TalkTime=0,rng=11..20}] run clone 3903 41 1221 3903 43 1223 3473 35 488
execute as @s[tag=Machine1Roll,scores={TalkTime=0,rng=21..30}] run clone 3904 41 1221 3904 43 1223 3473 35 488
execute as @s[tag=Machine1Roll,scores={TalkTime=0,rng=31..40}] run clone 3902 41 1221 3902 43 1223 3473 35 488
execute as @s[tag=Machine1Roll,scores={TalkTime=0,rng=41..55}] run clone 3901 41 1221 3901 43 1223 3473 35 488
execute as @s[tag=Machine1Roll,scores={TalkTime=0,rng=56..}] run clone 3899 41 1221 3899 43 1223 3473 35 488




#Machine 1 Rewards
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=1..3}] run tellraw @s {"text":"You received the 700 Coins Jackpot!","italic":true,"color":"gray"}
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=1..3}] run scoreboard players add @s Coins 700
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=1..3}] run playsound minecraft:entity.firework_rocket.launch ambient @s ~ ~ ~ 1 1 1

execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=4..10}] run tellraw @s {"text":"You received 100 Coins!","italic":true,"color":"gray"}
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=4..10}] run scoreboard players add @s Coins 100
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=4..10}] run playsound minecraft:entity.firework_rocket.launch ambient @s ~ ~ ~ 1 1 1

execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=11..20}] run tellraw @s {"text":"You received 30 Coins!","italic":true,"color":"gray"}
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=11..20}] run scoreboard players add @s Coins 30
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=11..20}] run playsound minecraft:entity.experience_orb.pickup ambient @s ~ ~ ~ 1 1 1

execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=21..30}] run tellraw @s {"text":"You received 15 Coins!","italic":true,"color":"gray"}
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=21..30}] run scoreboard players add @s Coins 15
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=21..30}] run playsound minecraft:entity.experience_orb.pickup ambient @s ~ ~ ~ 1 1 1

execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=31..40}] run tellraw @s {"text":"You received 15 Coins!","italic":true,"color":"gray"}
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=31..40}] run scoreboard players add @s Coins 15
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=31..40}] run playsound minecraft:entity.experience_orb.pickup ambient @s ~ ~ ~ 1 1 1

execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=41..55}] run tellraw @s {"text":"You received 8 Coins!","italic":true,"color":"gray"}
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=41..55}] run scoreboard players add @s Coins 8
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=41..55}] run playsound minecraft:entity.experience_orb.pickup ambient @s ~ ~ ~ 1 1 1

execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=56..}] run tellraw @s {"text":"You received 8 Coins!","italic":true,"color":"gray"}
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=56..}] run scoreboard players add @s Coins 8
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0,rng=56..}] run playsound minecraft:entity.experience_orb.pickup ambient @s ~ ~ ~ 1 1 1

execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0}] run scoreboard players set @s rng 0
execute as @s[tag=Machine1Roll,tag=RNGRolled,scores={TalkTime=0}] run tag @s add EndSlots

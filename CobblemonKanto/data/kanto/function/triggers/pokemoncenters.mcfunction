...
tag @a[x=4495,y=34,z=889,distance=..11,tag=!FlyVictory] add FlyVictory
tag @a[x=4458,y=54,z=1089,distance=..11,tag=!FlyIndigo] add FlyIndigo
...
tag @a[x=4296,y=28,z=-2347,distance=..11,tag=!FlyOne] add FlyOne
...
spawnpoint @a[x=4495,y=34,z=889,distance=..11,tag=FlyVictory] 4495 34 888
spawnpoint @a[x=4458,y=54,z=1089,distance=..11,tag=FlyIndigo] 4458 54 1087
...
spawnpoint @a[x=4296,y=28,z=-2347,distance=..11,tag=FlyOne] 4296 44 -2365

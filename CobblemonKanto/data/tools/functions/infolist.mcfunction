...
#execute as @e[x=-504,y=101,z=1229,r=3,type=villager] ~ ~ ~ tellraw @a[tag=infoverify] {"text":"-Vanilla villager found","italic":true,"color":"green"}
#execute as @e[x=-504,y=101,z=1229,r=3,type=!villager] ~ ~ ~ tellraw @a[tag=infoverify] {"text":"-Entity type NOT villager found","italic":true,"color":"red"}
...
#execute as @e[x=3907,y=42,z=1162,r=2,type=villager] ~ ~ ~ tellraw @a[tag=infoverify] ["",{"text":"3) "},{"text":"Vanilla villager found.","color":"green"},{"text":" ["},{"text":"Info","hoverEvent":{"action":"show_text","value":"This condition is used to check and ensure the custom pixelmon.hocon file is being used by the server. It appears it is!"}},{"text":"]"}]
#execute as @e[x=3907,y=42,z=1162,r=2,type=!villager] ~ ~ ~ tellraw @a[tag=infoverify] ["",{"text":"3) "},{"text":"Entity type NOT villager found.","color":"red"},{"text":" ["},{"text":"Info","hoverEvent":{"action":"show_text","value":"This condition is used to check and ensure the custom pixelmon.hocon file is being used by the server. This ISN'T the case! To fix, ensure you are using the custom \"config\" and \"pixelmon\" folders in your server folder or your .minecraft folder."}},{"text":"]"}]
#
...
execute as @e[x=3907,y=41,z=1165,dy=3,type=pixelmon:statue] run tag @a[tag=infoverify] add skip
